...
$(document).ready(function() {
    ...
    $('body').append('' +
        '<div id="styleSelector" class="menu-styler">' +
            ...
            '<div class="style-block">' +
                ...
                '<div class="theme-color layout-type">' +
                    '<a href="javascript:" class=" active" data-value="menu-dark" data-toggle="tooltip" title="Default Layout"><span></span><span></span></a>' +
                    '<a href="javascript:" class="" data-value="menu-light" data-toggle="tooltip" title="Light"><span></span><span></span></a>' +
                    '<a href="javascript:" class="" data-value="dark" data-toggle="tooltip" title="Dark"><span></span><span></span></a>' +
                    '<a href="javascript:" class="" data-value="reset" data-toggle="tooltip" title="Reset">Reset to Default</a>' +
                '</div>' +
                ...
                '<div class="tab-content" id="pills-cust-tabContent">' +
                    '<div class="tab-pane fade show active" id="pills-color" role="tabpanel" aria-labelledby="pills-color-tab">' +
                        ...
                        '<div class="theme-color header-color">' +
                            '<a href="javascript:" class=" active" data-value="header-default"><span></span><span></span></a>' +
                            '<a href="javascript:" class="" data-value="header-blue"><span></span><span></span></a>' +
                            '<a href="javascript:" class="" data-value="header-red"><span></span><span></span></a>' +
                            '<a href="javascript:" class="" data-value="header-purple"><span></span><span></span></a>' +
                            '<a href="javascript:" class="" data-value="header-lightblue"><span></span><span></span></a>' +
                            '<a href="javascript:" class="" data-value="header-dark"><span></span><span></span></a>' +
                        '</div>' +
                        '<h6>Menu background</h6>' +
                        '<div class="theme-color navbar-color">' +
                            '<a href="javascript:" class=" active" data-value="navbar-default"><span></span><span></span></a>' +
                            '<a href="javascript:" class="" data-value="navbar-blue"><span></span><span></span></a>' +
                            '<a href="javascript:" class="" data-value="navbar-red"><span></span><span></span></a>' +
                            '<a href="javascript:" class="" data-value="navbar-purple"><span></span><span></span></a>' +
                            '<a href="javascript:" class="" data-value="navbar-lightblue"><span></span><span></span></a>' +
                            '<a href="javascript:" class="" data-value="navbar-dark"><span></span><span></span></a>' +
                        '</div>' +
                        '<h6>Menu Brand Color</h6>' +
                        '<div class="theme-color brand-color">' +
                            '<a href="javascript:" class=" active" data-value="brand-default"><span></span><span></span></a>' +
                            '<a href="javascript:" class="" data-value="brand-blue"><span></span><span></span></a>' +
                            '<a href="javascript:" class="" data-value="brand-red"><span></span><span></span></a>' +
                            '<a href="javascript:" class="" data-value="brand-purple"><span></span><span></span></a>' +
                            '<a href="javascript:" class="" data-value="brand-lightblue"><span></span><span></span></a>' +
                            '<a href="javascript:" class="" data-value="brand-dark"><span></span><span></span></a>' +
                        '</div>' +
                        '<h6>Navbar Image</h6>' +
                        '<div class="theme-color navbar-images">' +
                            '<a href="javascript:" class="" data-value="navbar-image-1"><span></span><span></span></a>' +
                            '<a href="javascript:" class="" data-value="navbar-image-2"><span></span><span></span></a>' +
                            '<a href="javascript:" class="" data-value="navbar-image-3"><span></span><span></span></a>' +
                            '<a href="javascript:" class="" data-value="navbar-image-4"><span></span><span></span></a>' +
                            '<a href="javascript:" class="" data-value="navbar-image-5"><span></span><span></span></a>' +
                        '</div>' +
                    '</div>' +
                    ...
                    '<div class="tab-pane fade" id="pills-extra" role="tabpanel" aria-labelledby="pills-extra-tab">' +
                        ...
                        '<div class="theme-color active-color small">' +
                            '<a href="javascript:" class=" active" data-value="active-default"></a>' +
                            '<a href="javascript:" class="" data-value="active-blue"></a>' +
                            '<a href="javascript:" class="" data-value="active-red"></a>' +
                            '<a href="javascript:" class="" data-value="active-purple"></a>' +
                            '<a href="javascript:" class="" data-value="active-lightblue"></a>' +
                            '<a href="javascript:" class="" data-value="active-dark"></a>' +
                        '</div>' +
                        '<h6>Menu Title Color</h6>' +
                        '<div class="theme-color title-color small">' +
                            '<a href="javascript:" class=" active" data-value="title-default"></a>' +
                            '<a href="javascript:" class="" data-value="title-blue"></a>' +
                            '<a href="javascript:" class="" data-value="title-red"></a>' +
                            '<a href="javascript:" class="" data-value="title-purple"></a>' +
                            '<a href="javascript:" class="" data-value="title-lightblue"></a>' +
                            '<a href="javascript:" class="" data-value="title-dark"></a>' +
                        '</div>' +
                        '<div class="form-group mb-0">' +
                            '<div class="switch switch-primary d-inline m-r-10">' +
        ...
        '</div>');
    setTimeout(function(){
        $("#pills-cust-tabContent").slimScroll({
            setTop: "1px",
            size: '5px',
            wheelStep: 10,
            alwaysVisible : false,
    ...
    $('#menu-fixed').change(function() {
        if ($(this).is(":checked")) {
            ...
            setTimeout(function() {
                ...
                $(".navbar-content").css({'overflow':'visible','height':'100%'});
            }, 400);
        }
    });
    // Header Fixed
