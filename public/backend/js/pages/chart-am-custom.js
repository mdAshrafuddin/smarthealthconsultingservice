...
$(document).ready(function() {
    setTimeout(function() {
        ...
        // [ pie-Nested chart ] start
        $(function() {
            am4core.useTheme(am4themes_animated);

            var chart = am4core.create("am-pie-5", am4charts.PieChart);
        ...
        // [ pie-Nested chart ] end

        // [ pie-rounded chart ] start
        $(function() {
            am4core.useTheme(am4themes_animated);
            var chart = am4core.create("am-pie-8", am4charts.PieChart);
            chart.data = [{
                    country: "Lithuania",
                    value: 401
                },
        ...
        // [ pie-rounded chart ] end

        // [ pie-radius chart ] start
        $(function() {
            am4core.useTheme(am4themes_animated);
            var chart = am4core.create("am-pie-10", am4charts.PieChart);
            chart.data = [{
                    country: "Lithuania",
                    value: 260
                },
